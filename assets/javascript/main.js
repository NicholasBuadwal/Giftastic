var athletesArray = ["Kawhi Leonard", "Michael Jordan", "Lionel Messi", "Memphis Depay", "Vince Carter", "Johan Cruyff"];
...
function searchGif(gifName) {
    $.ajax({
            url: 'https://api.giphy.com/v1/gifs/search?q= ' + gifName + ' &api_key=MO0KDOVrYbfB01ttQMHRT7W7Fvr681tS',
            type: 'GET',
        })
